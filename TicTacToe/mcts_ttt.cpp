...
MCTS_TTT::MCTS_TTT(std::shared_ptr<TTT_Node> &root): MCTS<TTT_Action, TTT_State, TTT_Node>(root), root(root), rng((std::random_device())()) {};
MCTS_TTT::~MCTS_TTT() = default;
//
//double MCTS_TTT::ucb(const std::shared_ptr<TTT_Node> &node) {
...
//}
//
//std::shared_ptr<TTT_Node> MCTS_TTT::best_child_ucb(std::shared_ptr<TTT_Node> &curr){
...
//}
//
//std::shared_ptr<TTT_Node> MCTS_TTT::select() {
//    auto current = root;
...
//}
//
//std::shared_ptr<TTT_Node> MCTS_TTT::expand(std::shared_ptr<TTT_Node> &leaf) {
...
//    auto child = std::make_shared<TTT_Node>(new_state, last_action, leaf);
//    child->unexpanded = child->get_actions();
//    leaf->children.insert(std::make_pair(last_action, child));
//    return child;
//}
//
//std::shared_ptr<TTT_Node> MCTS_TTT::simulate(const std::shared_ptr<TTT_Node> &leaf) {
//    auto current = leaf;
...
//}
//
//void MCTS_TTT::backprop(std::shared_ptr<TTT_Node> &terminal) {
...
//}
//
//std::shared_ptr<TTT_Node> MCTS_TTT::best_child(const std::shared_ptr<TTT_Node> &node) {
...
//}
//
//bool MCTS_TTT::is_valid(const std::shared_ptr<TTT_Node> &current_node, TTT_Action& a) {
//    return current_node->get_state().is_valid_action(a);
//}
//
//std::shared_ptr<TTT_Node> MCTS_TTT::take_action(const std::shared_ptr<TTT_Node> &current_node, TTT_Action& a) {
